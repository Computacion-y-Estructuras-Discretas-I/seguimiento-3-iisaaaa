...
public class Main {
    ...
    public boolean esPar(char abrir, char cerrar) {
        return (abrir == '(' && cerrar == ')') ||
                (abrir == '[' && cerrar == ']') ||
                (abrir == '{' && cerrar == '}');
    ...
    /**
     * Encuentra y muestra todos los pares unicos de numeros que sumen objetivo
     * usando TablasHash.
     * 
     ...
     * @throws Exception 
     */
    public static void encontrarParesConSuma(int[] numeros, int objetivo) throws Exception {
